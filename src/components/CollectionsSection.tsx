    ...
    <section ref={ref} className="py-16 md:py-24 bg-background overflow-hidden">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="relative">
          ...
          <button 
            onClick={goToPrev}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 z-10 w-12 h-12 bg-background/90 backdrop-blur-sm rounded-full items-center justify-center shadow-lg hover:bg-background transition-colors hidden md:flex"
            aria-label="Previous"
          >
          ...
          <button 
            onClick={goToNext}
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 z-10 w-12 h-12 bg-background/90 backdrop-blur-sm rounded-full items-center justify-center shadow-lg hover:bg-background transition-colors hidden md:flex"
            aria-label="Next"
          >
            ...
            >
              ...
              >
                {collections.map((collection) => (
                  <CollectionCard key={collection.id} collection={collection} isMobile={true} />
                ))}
              </motion.div>
            </div>
          ) : (
            ...
            <div className="overflow-hidden">
              ...
              >
                ...
                {Array.from({ length: totalSlides }).map((_, slideIndex) => (
                  ...
                  >
                    {collections.slice(slideIndex * 3, slideIndex * 3 + 3).map((collection) => (
