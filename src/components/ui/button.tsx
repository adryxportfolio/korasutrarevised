  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground px-8 py-4 text-base tracking-wide hover:shadow-lg hover:scale-105 transform",
        gold: "bg-accent text-accent-foreground hover:bg-accent/90 hover:shadow-lg",
        elegant: "bg-transparent border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground tracking-widest uppercase text-xs",
        subtle: "bg-secondary/50 text-foreground hover:bg-secondary hover:shadow-sm",
      },
      size: {
